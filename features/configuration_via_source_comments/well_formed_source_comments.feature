  ...
  Scenario: Enable smell detector explicitly
    ...
    And it reports:
      ...
      enable_detector_explicitly.rb -- 1 warning:
        [3]:TooManyInstanceVariables: Alfa has at least 5 instance variables [https://github.com/troessner/reek/blob/v4.8.1/docs/Too-Many-Instance-Variables.md]
      """
  ...
  Scenario: Configure smell detector with a detector specific option that makes it report again
    ...
    And it reports:
      ...
      configure_detector_specific_option.rb -- 1 warning:
        [3]:TooManyInstanceVariables: Alfa has at least 3 instance variables [https://github.com/troessner/reek/blob/v4.8.1/docs/Too-Many-Instance-Variables.md]
      """
