Feature: Basic smell detection
  ...
  Scenario: Correct smells from inline.rb
    ...
    optparse.rb -- 117 warnings:
      ...
      DuplicateMethodCall: OptionParser#make_switch calls notwice(if a ... end, klass, "type") 2 times
      ...
      DuplicateMethodCall: OptionParser::Switch#summarize calls left.collect do |s| ... end 2 times
      DuplicateMethodCall: OptionParser::Switch#summarize calls left.collect do |s| ... end.max 2 times
      DuplicateMethodCall: OptionParser::Switch#summarize calls left.collect do |s| ... end.max.to_i 2 times
      ...
      RepeatedConditional: OptionParser tests (argv.size == 1) && (Array === argv[0]) at least 3 times
