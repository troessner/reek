Feature: Reek can be controlled using command-line options
      ...
      Configuration:
          -c, --config FILE                Read configuration options from FILE
              --smell SMELL                Only look for a specific smell.
                                           ...
                                           Check out https://github.com/troessner/reek/blob/v6.1.0/docs/Code-Smells.md for a list of smells
  ...
  Scenario: List all available smell detectors
    ...
    And it reports:
      ...
      Check out https://github.com/troessner/reek/blob/v6.1.0/docs/Code-Smells.md for a details on each detector
      """
