  ...
  Scenario: Indicate smells and print them as yaml when using files
    ...
    And it reports this yaml:
      ...
      - context: Smelly#x
        ...
        source: smelly.rb
        name: x
        documentation_link: https://github.com/troessner/reek/blob/v6.1.2/docs/Uncommunicative-Method-Name.md
      - context: Smelly#x
        lines:
        - 5
        ...
        source: smelly.rb
        name: y
        documentation_link: https://github.com/troessner/reek/blob/v6.1.2/docs/Uncommunicative-Variable-Name.md
      """
  ...
  Scenario: Indicate smells and print them as yaml when using STDIN
    ...
    And it reports this yaml:
      ...
      - smell_type: IrresponsibleModule
        ...
        documentation_link: https://github.com/troessner/reek/blob/v6.1.2/docs/Irresponsible-Module.md
      """
